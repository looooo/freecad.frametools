# Dokumentation — FrameTools Image Workflow

**Hauptdokument (Spezifikation für Neuimplementierung):**

| Dokument | Inhalt |
|----------|--------|
| **[IMAGE_PIPELINE_SPEC.md](IMAGE_PIPELINE_SPEC.md)** | **Konsolidiert:** Workflow, Mathematik, Kameramodell, Erkenntnisse, Vereinfachungen |

Einzelthemen (Detail / Ist-Zustand):
